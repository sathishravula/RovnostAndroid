...
@Module(injects = {LoginActivity.class , RegisterActivity.class, LandingActivity.class, ForgotPassword.class,DashBoardActivity.class, DoctorsActivity.class, RequestConsultationActivity.class, ConfirmationActivity.class}, library = true, complete = false)
